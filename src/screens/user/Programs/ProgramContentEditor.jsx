...
//         {/* Froala Rich Text Editor Component */}
//         <View style={styles.fieldGroup}>
...
//           <TouchableOpacity
//             style={[styles.draftBtn, !isEditing && styles.disabledBtn]}
//             disabled={!isEditing}
//             onPress={handleDraft}
//           >
...
//   publishBtn: { backgroundColor: "#2563eb", paddingHorizontal: 20, paddingVertical: 10, borderRadius: 8 },
...
//   input: { borderWidth: 1, borderColor: "#d1d5db", borderRadius: 8, padding: 12, fontSize: 14, color: "#000" },
//   disabledInput: { backgroundColor: "#f3f4f6", color: "#6b7280" },
//   inputError: { borderColor: "#ef4444" },
//   errorText: { color: "#ef4444", fontSize: 12, marginTop: 4 },
//   footer: { flexDirection: "row", justifyContent: "flex-end", alignItems: "center", gap: 12, marginTop: 24, paddingTop: 16, borderTopWidth: 1, borderTopColor: "#e5e7eb" },
//   draftBtn: { borderWidth: 1, borderColor: "#2563eb", paddingHorizontal: 16, paddingVertical: 12, borderRadius: 8 },
...
export default function ProgramContentEditor({
  ...
  onCancel,
  isEditing,
  setIsEditing, // <--- Receive setIsEditing function
  titleLabel,
  publishProgram,
  isNew,
}) {
