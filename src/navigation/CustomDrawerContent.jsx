...
//   { name: 'Programs', icon: 'book-outline', route: 'programs' },
//   { name: 'Universities', icon: 'school-outline', route: 'Universities' },
//   { name: 'Students', icon: 'person-outline', route: 'Students' },
//   { name: 'Resources', icon: 'bookmark-outline', route: 'Resources' },
//   { name: 'Offers', icon: 'pricetag-outline', route: 'Offers' },
//   { name: 'Communication', icon: 'mail-outline', route: 'communication' },
// ];
...
//   // Resolve current active tab route
//   const focusedRoute = state?.routes[state.index];
//   const activeRouteName =
//     getFocusedRouteNameFromRoute(focusedRoute) || 'dashboard';
...
//     // Directly navigate to the screen within TabNavigator
